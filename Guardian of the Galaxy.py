...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("Thanks For Playing but Game Over !!!", 1, (255,255,255))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Welcome to the Guardian of the Galaxy...", 1, (255,255,255))
